...
class Repository:
    def __init__(self, dir_path, doprint=True):
        ...
        if doprint:
            ...
            print(self.instructor_table_db(os.path.join(self._dir_path, '810_startup.db')))
    ...
    def instructor_table_db(self, dbpath):
        """print a instructor prettytable from database"""
        try:
...
def main():
    stevens = Repository(r"C:\Users\Ejona's Surface\PycharmProjects\Homework 11")
